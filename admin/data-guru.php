        ...
        <div class="konten">
            ...
            <div class="konten_isi">
                ...
                <div class="konten_pengaturan">
                    <a href="tambah-data-guru"><button type="button" class="btn btn-success">Tambah guru</button></a>
                </div>
                            ...
                            while ($row = $result_guru->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class='aksi'>
                                        ...
                                        <a href='#' class='deleteBtn' data-nip='${row['nip']}'><button type='button' data-bs-toggle='tooltip' class='btn btn-danger btn-sm' title='Hapus'><i class='bx bx-trash'></i></button></a>
                                    </td>
                                </tr>
                                ";
                                $no++;
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.deleteBtn').on('click', function (e) {
                e.preventDefault();
                var nip = $(this).data('nip'); // Get the NIP of the teacher

                // Set the href of the delete link inside the modal to the delete URL
                $('#deleteLink').attr('href', 'hapus-data-guru?nip=' + nip);
