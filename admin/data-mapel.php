...
<body>
                            ...
                            if ($result_mapel && $result_mapel->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td class='aksi'>
                                        ...
                                        <button type='button' class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#deleteModal' data-id_mapel='${row['id_mapel']}' data-mapel='${row['nama_mapel']}'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus mata pelajaran <strong id="mapel-name"></strong>?
                </div>
    ...
    <script>
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            const mapelId = button.getAttribute('data-id_mapel');
            const mapelName = button.getAttribute('data-mapel');
            const deleteLink = document.getElementById('delete-link');

            document.getElementById('mapel-name').textContent = mapelName;
            deleteLink.href = 'hapus-data-mapel?id_mapel=' + mapelId;
        });
    </script>
</body>
