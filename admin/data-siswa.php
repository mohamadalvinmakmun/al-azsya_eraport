                        ...
                        <tbody>
                            ...
                            if ($result_siswa && $result_siswa->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td>${row['no_telp']}</td>
                                    <td class='aksi'>
                                       <a href='ubah-data-siswa?nis={$row['nis']}' class='btn btn-primary btn-sm' title='Ubah'><i class='bx bx-pencil'></i></a>
                                    <button type='button' class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#modalHapus' data-url='hapus-data-siswa?nis={$row['nis']}'>
