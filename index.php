                            ...
                            <div class="col-md-4 col-xl-3">
                                <div class="card bg-c-blue guru-card">
                                    <div class="card-block">
                                        ...
                                        <h3 class="text-left"><i class="fa fa-cart-plus f-left"></i><span>2024/2025</span></h3>
    ...
    ?>
                    <div class="konten_table table-responsive">
                        <table class="table table-bordered caption-top" id="kalender">
                            <caption>Kalender Akademik 2025</caption>
                            <thead>
                                <tr>
                                    <th>Tanggal</th>
                                    <th>Kegiatan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo JADWAL['tgl11'] ?></td>
                                    <td><?php echo JADWAL['agd11'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo JADWAL['tgl12'] ?></td>
                                    <td><?php echo JADWAL['agd12'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo JADWAL['tgl13'] ?></td>
                                    <td><?php echo JADWAL['agd13'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo JADWAL['tgl14'] ?></td>
                                    <td><?php echo JADWAL['agd14'] ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo JADWAL['tgl15'] ?></td>
                                    <td><?php echo JADWAL['agd15'] ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
