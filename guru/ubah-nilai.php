                        ...
                        <div class="mb-3">
                            <div class="dropdown">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaicp1" min="0" max="100" class="form-control" id="nilaiSiswaCP1" value="<?php echo $row['cp1']; ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaicp2" min="0" max="100" class="form-control" id="nilaiSiswaCP2" value="<?php echo $row['cp2']; ?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan nilai dari 0 hingga 100
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaicp3" min="0" max="100" class="form-control" id="nilaiSiswaCP3" value="<?php echo $row['cp3']; ?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan nilai dari 0 hingga 100
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaicp4" min="0" max="100" class="form-control" id="nilaiSiswaCP4" value="<?php echo $row['cp4']; ?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan nilai dari 0 hingga 100
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaiuts" min="0" max="100" class="form-control" id="nilaiSiswaUTS" value="<?php echo $row['uts']; ?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan nilai dari 0 hingga 100
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nilaiuas" min="0" max="100" class="form-control" id="nilaiSiswaUAS" value="<?php echo $row['uas']; ?>" required>
                                    <div class="invalid-feedback">
                                        Masukkan nilai dari 0 hingga 100
                                    </div>
                                </div>
